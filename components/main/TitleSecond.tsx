...
export default function TitleSecond() {
    return (
        <div className='w-full relative shadow-card-upload-black'>
            <img className='absolute top-0 left-0 h-full w-full' src='/bg1.jpg' />
            <div className='z-20 pt-28 pb-24 relative flex w-full flex-col items-center text-[white]'>
                <div className='text-xl mb-6 mt-4 md:text-2xl lg:text-4xl font-semibold font-Urbansit    '>Unleash Your AI Expertise on the Market!</div>
